                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-auto col-8 my-auto">
                            <div class="h-100">
                                ...
                                <span class="mt-3">
                                    <form action="{{ route('admin.profiles.update', Auth::user()->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card" id="basic-info">
                                            ...
                                            <form action="{{ route('admin.changePhoneAddress', Auth::user()->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <input class="form-control" placeholder=""
                                                                aria-label="First Name..." type="text" name="name"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <input class="form-control" placeholder=""
                                                                aria-label="First Name..." type="text" name="address"
                                                                value="{{ Auth::user()->address }}">
                                                        </div>
                                                    </div>
                                                    <div class="mt-4 mx-auto mb-2">
                                                        <button type="submit"
                                                            class="btn bg-gradient-primary btn-sm float-end">Update
                                                            Account Info
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card" id="password">
                                            ...
                                            <form action="{{ route('admin.changePassword', Auth::user()->id) }}"
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <button type="submit"
                                                        class="btn bg-gradient-primary btn-sm float-end mt-3 mb-4">Update
                                                        password</button>
                                                </div>
                                            </form>
                            ...
                            <div class="card mx-2">
                                ...
                                <div class="d-flex">
                                    <a href="javascript:;" class="mt-3 ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/kpay.png') }}">
                                    </a>
                                    <div class="mt-3 ms-2">
                                ...
                                <div class="d-flex mt-3">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/wpay.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
                                ...
                                <div class="d-flex mt-3">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/cbpay.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
                                ...
                                <div class="d-flex mt-3">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/cb.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
                                ...
                                <div class="d-flex mt-3">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/aya_logo.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
                                ...
                                <div class="d-flex mt-3">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/a1.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
                                ...
                                <div class="d-flex mt-3 mb-4">
                                    <a href="javascript:;" class="ms-4">
                                        <img class="avatar avatar-l shadow"
                                            src="{{ asset('admin_app/assets/img/bank_acc_icon/kb1.png') }}">
                                    </a>
                                    <div class="ms-2">
                                        <!-- <p class="text-sm mb-0 text-capitalize">User Name</p> -->
                                        <h6 class="mb-0">
